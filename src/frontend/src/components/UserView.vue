      ...
      <el-aside width="200px" class="menubar">
        ...
        <el-menu
          ...
          <el-submenu index="1">
            ...
            <el-menu-item index="1-1">Сохнаненные анкеты</el-menu-item>
            <el-menu-item index="1-2">Пройденные анкеты</el-menu-item>
            <el-menu-item index="1-3">Выход</el-menu-item>
          </el-submenu>
          <el-menu-item index="2">
            <i class="el-icon-document"></i>
            <span>Список анкет</span>
          </el-menu-item>
        </el-menu>
      </el-aside>
      <el-container>
        ...
        <el-main>
          <quiz-table :table-data="quizData"
                      :visible="tabVisible"
                      height="450px"
                      width="900px"
                      class="quiz-table"
                      @answer-click="fillQuizForm"
          ></quiz-table>
          <el-dialog
              ...
              :modal="true"
              center>
            <answer-form v-if="currentQuiz !== undefined"
                         :quiz-obj="currentQuiz"
                         @end-quiz="finishQuiz"
                         @save-progress="saveProgress"
                         @cancel-quiz="cancelQuiz"></answer-form>
          </el-dialog>
        </el-main>
      </el-container>
    </el-container>
...
export default {
  ...
  created: function () {
    this.setPageHeader("2")
  },
  methods: {
    handleOpen(key) {
      console.log('open index =' + key);
    },
    handleClose(key) {
      console.log('close index =' + key);
    },
    itemClick(index) {
      this.setPageHeader(index)
    },
    setPageHeader(index) {
      if (index === "1-1") {
        this.pageHeader = 'Сохнаненные анкеты'
      } else if (index === "1-2") {
        this.pageHeader = 'Пройденные анкеты'
      } else if (index === "2") {
        this.pageHeader = 'Список анкет'
      }
    },
    fillQuizForm(arrayIndex) {
